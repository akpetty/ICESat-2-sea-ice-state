...
def gen_netcdf(savePathT, outStr, xpts2d, ypts2d, lons2d, lats2d, lead_fraction1, lead_fraction2, epsg):
    f = nc4.Dataset(savePathT+'IS2lead_fraction_'+outStr+'_gridded_prelim.nc','w', format='NETCDF4') #'w' stands for write
...
leadsG2, _=ut.bin_data_nsidc(xv2, yv2, leads.lead_fraction_v1.values, xptsG, yptsG, dx)
...
gen_netcdf(savePath, outstr, xptsG, yptsG, lonG, latG, leadsG,leadsG2, epsg)
